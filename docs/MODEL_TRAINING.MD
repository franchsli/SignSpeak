...
but you still have a proper dataset for either [videos](docs/DATASET_CREATION.md#L50-L62) or [images](docs/DATASET_CREATION.md#L84-L98)
...
After you have a trained model, you can [translate](docs/TRANSLATION.MD).
